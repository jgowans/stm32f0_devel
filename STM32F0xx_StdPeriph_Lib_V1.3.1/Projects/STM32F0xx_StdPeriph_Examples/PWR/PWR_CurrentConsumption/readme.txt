...
Here below a detailed description of the example code:
 ...
 1. After reset, the program waits for Joystick SEL button connected to the PA.00 to be 
    pressed to enter the selected low power mode.
     ...
     - In STANDBY_MODE test, press Tamper button to exit the low power mode.
 ...
 2. Low power modes description:
    ...
    ==============
            - RTC OFF
            - IWDG and LSI OFF
            - Wakeup using WakeUp Pin2 (PC.13, connected to Tamper push-button on EVAL board)
